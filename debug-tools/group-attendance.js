...
// The methods lifted out of the page below call PortalUI helpers, so the
// real class has to be in scope. tests/portalui.js is generated by
// tests/extract-portalui.js and deliberately not committed.
try {
  global.PortalUI = require('../tests/portalui.js');
} catch (e) {
  console.log('This grid needs the shared helpers. Run: node tests/extract-portalui.js');
  process.exit(1);
}
